                       ...
                       <div className="space-y-3 mt-6 p-6 bg-gray-50 rounded-lg border border-gray-200 animate-fade-in">
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                           ...
                           <FormField
                             control={form.control}
                             name="adminLastName"
                             rules={{ required: "Admin Last  Name is required.", minLength: { value: 2, message: "Admin Last Name must be at least 2 characters." } }}
                             render={({ field }) => (
                               <FormItem>
                                 <FormLabel>Admin Last Name</FormLabel>
                                 <FormControl>
                                   <Input type="text" placeholder="Doe" {...field} className="h-12 text-base border-gray-300 focus:border-hrms-primary focus:ring-hrms-primary" />
                                 </FormControl>
                                 <FormMessage />
                               </FormItem>
                             )}
