    ...
    <div className="mb-25">
      ...
      <div className="w-full min-h-[135vh] rounded-tl-[150px] rounded-br-[55px]  relative overflow-hidden">
        ...
        <div className="flex flex-wrap justify-center items-center pt-16 px-4">
          <div className="w-[650px] text-center md:text-left p-4 md:p-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-4 animate-fade-in-up">
              All-in-one HR for a <span className="text-indigo-600">Global Workforce</span>
            </h1>

            {/* Sub-headline / Descriptive Text */}
            <p className="text-lg md:text-xl text-gray-600 mb-8 animate-fade-in-up delay-100">
              Manage payroll, onboarding, benefits, and compliance from a single
              intuitive platform. Empower your team, simplify your operations.
            </p>
        ...
        <div className="mt-16 px-4">
          <p className="text-center mb-8 text-gray-600 font-medium">FlexHR is trusted by 35,000+ companies from startups to enterprise businesses</p>
          <div className="flex justify-center items-center gap-8 md:gap-12 opacity-60 grayscale hover:grayscale-0 transition-all duration-300">
            <div className="w-24 h-12 bg-gray-400 rounded-lg flex items-center justify-center text-white font-bold text-sm">LOGO</div>
            <div className="w-24 h-12 bg-gray-400 rounded-lg flex items-center justify-center text-white font-bold text-sm">LOGO</div>
            <div className="w-24 h-12 bg-gray-400 rounded-lg flex items-center justify-center text-white font-bold text-sm">LOGO</div>
            <div className="w-24 h-12 bg-gray-400 rounded-lg flex items-center justify-center text-white font-bold text-sm">LOGO</div>
          </div>
