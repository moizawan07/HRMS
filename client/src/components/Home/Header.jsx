...
//       {/* Sample Content */}
//       <main className="flex-1 bg-gradient-to-br from-purple-50 to-blue-50 p-8" style={{backgroundColor: '#E6E2FC'}}>
//         <div className="max-w-7xl mx-auto">
//           <Card className="p-8 bg-white/80 backdrop-blur-sm">
//             <h1 className="text-3xl font-bold text-gray-800 mb-4">Welcome to HRMS Pro</h1>
//             <p className="text-gray-600 mb-6">
//               Your comprehensive Human Resource Management System for efficient workforce management.
//             </p>
//             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//               <Card className="p-6 bg-purple-50 border-purple-200">
//                 <Users className="w-8 h-8 text-purple-600 mb-3" />
//                 <h3 className="font-semibold text-gray-800 mb-2">Employee Management</h3>
//                 <p className="text-sm text-gray-600">Manage your workforce efficiently</p>
//               </Card>
//               <Card className="p-6 bg-blue-50 border-blue-200">
//                 <Calendar className="w-8 h-8 text-blue-600 mb-3" />
//                 <h3 className="font-semibold text-gray-800 mb-2">Attendance Tracking</h3>
//                 <p className="text-sm text-gray-600">Monitor employee attendance</p>
//               </Card>
//               <Card className="p-6 bg-green-50 border-green-200">
//                 <FileText className="w-8 h-8 text-green-600 mb-3" />
//                 <h3 className="font-semibold text-gray-800 mb-2">Payroll Processing</h3>
//                 <p className="text-sm text-gray-600">Streamlined payroll management</p>
//               </Card>
//             </div>
//           </Card>
//         </div>
